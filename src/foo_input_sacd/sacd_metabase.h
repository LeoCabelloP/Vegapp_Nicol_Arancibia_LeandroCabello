...
public:
	...
	void set_track_info(t_uint32 track_number, const file_info& track_info, bool is_linked = false);
...
private:
	...
	void delete_tags(IXML_NodePtr node, const char* tag_type, bool is_linked);
