...
#ifndef _DVDA_BLOCK_H_INCLUDED
#define _DVDA_BLOCK_H_INCLUDED
...
constexpr int SEGMENT_HEADER_BLOCKS = 16;
constexpr int SEGMENT_HEADER_SIZE = SEGMENT_HEADER_BLOCKS * DVD_BLOCK_SIZE;
